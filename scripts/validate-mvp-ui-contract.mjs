...
const requiredAppFragments = [
  ...
  'app-shell clinical-app-shell',
  'workspace clinical-workspace',
  'className="clinical-topbar"',
  'className="demo-privacy-boundary"',
  '<WorkspacePageHeader',
...
for (const legacySelector of [
  ...
  'patient-current-report-v2',
  'anatomy-showcase-v3',
  'anatomy-showcase-copy-v3',
  'analytics-error-v3',
  'analytics-metrics-v3',
  'analytics-report-card-v3',
  'settings-grid-v2',
  'settings-grid-v3',
  'settings-actions-v2',
  'module-action-bar-v3',
  'intake-card-v2',
  'intake-heading-v2',
  'intake-actions-v2',
  'suggestion-list-v2',
...
for (const [file, obsoleteClass] of [
  ...
  ['src/components/PatientsModule.tsx', 'patient-current-report-v2'],
  ['src/components/PatientsModule.tsx', 'anatomy-showcase-v3'],
  ['src/components/PatientsModule.tsx', 'anatomy-showcase-copy-v3'],
  ['src/components/AnalyticsModule.tsx', 'analytics-error-v3'],
  ['src/components/AnalyticsModule.tsx', 'analytics-metrics-v3'],
  ['src/components/AnalyticsModule.tsx', 'analytics-report-card-v3'],
  ['src/components/DemoSettings.tsx', 'settings-grid-v2'],
  ['src/components/DemoSettings.tsx', 'settings-grid-v3'],
  ['src/components/DemoSettings.tsx', 'settings-actions-v2'],
  ['src/components/DemoSettings.tsx', 'module-action-bar-v3'],
  ['src/components/ReportIntake.tsx', 'intake-card-v2'],
  ['src/components/ReportIntake.tsx', 'intake-heading-v2'],
  ['src/components/ReportIntake.tsx', 'intake-actions-v2'],
  ['src/components/ReportIntake.tsx', 'suggestion-list-v2'],
  ['src/components/ReportComposer.tsx', 'report-card-v2'],
  ['src/components/ReportComposer.tsx', 'report-composer-v3'],
  ['src/components/ReportComposer.tsx', 'explanation-heading-v2'],
  ['src/components/ReportComposer.tsx', 'review-gate-v2'],
  ['src/components/ReportComposer.tsx', 'review-approved-v2'],
  ['src/components/ReportComposer.tsx', 'share-box-v2'],
  ['src/components/ReportComposer.tsx', 'publish-zone-v3'],
